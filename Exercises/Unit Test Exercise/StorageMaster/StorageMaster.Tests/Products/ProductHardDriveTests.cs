namespace StorageMaster.Tests
{
    ...
    public class ProductHardDriveTests
    {
        ...
        {
            this.product = new HardDrive(5);
            var exceptedProductPrice = 5;
        ...
        {
            var ex = Assert.Throws<InvalidOperationException>(() => this.product = new HardDrive(price)).Message;
        ...
        {
            this.product = new HardDrive(5);
            var exceptedProductName = "HardDrive";
